...
import '../data/verbal_reasoning_questions.dart';
import '../models/question_model.dart';
import '../utils/constants.dart';

class VerbalTestScreen extends ConsumerStatefulWidget {
  const VerbalTestScreen({super.key});

  @override
  ConsumerState<VerbalTestScreen> createState() => _VerbalTestScreenState();
}

class _VerbalTestScreenState extends ConsumerState<VerbalTestScreen> {
  ...
  void _selectRandomQuestions() {
    final easyQuestions = verbalReasoningQuestions
        .where((q) => q.difficulty == 'easy')
        .toList();
    final mediumQuestions = verbalReasoningQuestions
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Verbal Reasoning', style: TextStyle(color: Colors.white)),
                      ...
                      Expanded(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            const Text(
                              'Measure your vocabulary, comprehension, and logical reasoning',
                              style: TextStyle(
  ...
  Widget _buildResultsScreen() {
    ...
    if (percentage >= 80) {
      emoji = '🏆';
      message = 'Excellent! Outstanding verbal skills!';
      color = _electricBlue;
