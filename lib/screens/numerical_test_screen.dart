...
import '../data/numerical_reasoning_questions.dart';
import '../models/question_model.dart';
import '../utils/constants.dart';

class NumericalTestScreen extends ConsumerStatefulWidget {
  const NumericalTestScreen({super.key});

  @override
  ConsumerState<NumericalTestScreen> createState() => _NumericalTestScreenState();
}

class _NumericalTestScreenState extends ConsumerState<NumericalTestScreen> {
  ...
  void _selectRandomQuestions() {
    final easyQuestions = numericalReasoningQuestions
        .where((q) => q.difficulty == 'easy')
        .toList();
    final mediumQuestions = numericalReasoningQuestions
    ...
    if (percentage >= 75) {
      ...
      try {
        final existing = await Supabase.instance.client
            ...
            .select()
            .eq('user_id', user.id)
            .eq('test_name', 'Numerical Reasoning')
            .maybeSingle();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Numerical Reasoning', style: TextStyle(color: Colors.white)),
                      ...
                      Expanded(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            const Text(
                              'Measure your number skills and data interpretation',
                              style: TextStyle(
  ...
  Widget _buildResultsScreen() {
    ...
    if (percentage >= 80) {
      emoji = '🏆';
      message = 'Excellent! Outstanding numerical skills!';
      color = _electricBlue;
